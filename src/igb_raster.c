...
static int fill_tri(igb_raster_tri *t, const igb_mesh *m, int a, int b, int c, const uint8_t *tex,
                    int tw, int th) {
...
int igb_raster_frame(const igb_raster *r, const float view[16], int w, int h, uint8_t *rgba,
                     float *zbuf) {
